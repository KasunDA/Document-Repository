    <div class="container" id = 'auth_box_login'>
    <script src="<?php echo base_url('static/js/custom.js'); ?>"></script>
      ...
      <fieldset>
        ...
        <div class="input">
          <input style = "width:100%" type="text" name="txt_username" placeholder="Username" required />
          <span><i class="fa fa-envelope-o"></i></span>
        </div>
        
        <div class="input">
          <input style = "width:100%" type="password" placeholder="Password" name="txt_password" required />
